...
export default function YouTubeCard() {
  ...
  const handleDownloadJpeg = () => {
    ...
    link.download = "youtube-card.jpg";
  ...
  const handleDownloadVideo = useCallback(async (format: "mp4" | "webm" = "mp4") => {
    ...
    a.href = url;
    a.download = `youtube-card-${loopSeconds}s.${format}`;
  ...
  const openRaw = () => {
    ...
    window.open(`${window.location.origin}${window.location.pathname}?view=youtube&raw=1&settings=${encoded}`, "_blank");
  };
        ...
        {showText && (
          <div style={styles.textLayer}>
            <div style={styles.headlineBlock}>
              ...
              <div style={styles.headline}>JULY 25-26</div>
            </div>
...
<head>
<meta charset="UTF-8" />
<title>Startup School 2026 — YouTube card</title>
...
<style>
  ...
  .headline-block { position: absolute; top: 90px; left: 90px; display: flex; flex-direction: column; gap: 4px; }
  ...
  .headline { font-size: 124px; font-weight: 400; letter-spacing: -0.01em; line-height: 1.05; text-transform: uppercase; }
  .location { position: absolute; top: 510px; right: 120px; font-size: 124px; font-weight: 400; letter-spacing: -0.01em; text-transform: uppercase; }
  .register { position: absolute; bottom: 90px; left: 90px; font-size: 124px; font-weight: 400; letter-spacing: -0.01em; text-transform: uppercase; }
</style>
</head>
<body>
<div id="card">
  ...
  <div class="text-layer" id="text" style="display:none">
    <div class="headline-block">
      ...
      <div class="headline">JULY 25-26</div>
    </div>
